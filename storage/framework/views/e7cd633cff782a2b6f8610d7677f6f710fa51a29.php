        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" id="searchForm1" action="<?php echo e(route('summery-report-export')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="box-body">
    ...
    <script>
        $(function() {
            var dt = $('#reportTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo route('summery-report-datatable'); ?>",
                    data: function (d) {
...
<?php echo $__env->make('../layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/crud-app/resources/views/reports/report_summery.blade.php ENDPATH**/ ?>