        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" id="searchForm1" action="<?php echo e(route('report-details-export')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="box-body">
...
<script>
    $(function() {
       var dt = $('#reportTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo route('report-details-datatable'); ?>",
                data: function (d) {
                    d.status = $('#status').val();
...
<?php echo $__env->make('../layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/crud-app/resources/views/reports/report_details.blade.php ENDPATH**/ ?>